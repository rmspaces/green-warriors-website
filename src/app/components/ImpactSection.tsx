...
export function ImpactSection() {
  ...
  return (
    <section id="impact" className="py-16 md:py-24 bg-gradient-to-br from-emerald-50 to-white">
            ...
            {impacts.map((impact, index) => {
              ...
              return (
                <Card key={index} className="p-8 text-center hover:shadow-xl transition-all hover:-translate-y-2">
                  ...
                  <p className="text-4xl font-bold text-emerald-700 mb-2">{impact.stat}</p>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-700">
                  Your support creates <span className="font-bold text-emerald-700">generational change</span> — not just short-term aid.
                </p>
