  ...
  return (
    <section id="about" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div className="space-y-6">
            <p className="text-lg text-gray-700">
              The <span className="font-bold text-emerald-700">Green Warriors Program (GWP)</span> is the Eco Sustainability Foundation's flagship initiative.
            </p>
            <p className="text-lg text-gray-700">
              ...
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0">
                    {index === 0 && <GraduationCap className="text-emerald-700" size={20} />}
                    {index === 1 && <Heart className="text-emerald-700" size={20} />}
                    {index === 2 && <Users className="text-emerald-700" size={20} />}
                    {index === 3 && <Briefcase className="text-emerald-700" size={20} />}
                  </div>
        ...
        <div className="mt-12 bg-gradient-to-br from-emerald-700 to-emerald-900 rounded-2xl p-8 md:p-12 text-white text-center">
