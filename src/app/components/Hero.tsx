...
export function Hero() {
  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-[#F5F7ED] via-white to-[#F5F7ED]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="inline-block px-4 py-2 bg-[#E8EDCF] text-[#5A6727] rounded-full text-sm font-medium">
              Eco Sustainability Foundation
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
              Green Warriors Program
            </h1>
            <p className="text-xl md:text-2xl text-[#6B7A2F]">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                className="bg-[#6B7A2F] hover:bg-[#5A6727] text-white px-8 py-6 text-lg"
              >
              ...
              <Button
                ...
                className="border-[#6B7A2F] text-[#6B7A2F] hover:bg-[#F5F7ED] px-8 py-6 text-lg"
              >
                Learn More
              </Button>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl max-w-xs">
              <p className="text-4xl font-bold text-[#6B7A2F]">6 months</p>
